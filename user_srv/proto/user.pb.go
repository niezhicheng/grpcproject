...
var file_user_proto_rawDesc = []byte{
	...
	0x22, 0x34, 0x0a, 0x0c, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x12, 0x10, 0x0a, 0x03, 0x6d, 0x73, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6d,
	0x73, 0x67, 0x12, 0x12, 0x0a, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03,
	0x52, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x32, 0x31, 0x0a, 0x07, 0x53, 0x61, 0x79, 0x4e, 0x61, 0x6d,
	0x65, 0x12, 0x26, 0x0a, 0x08, 0x53, 0x61, 0x79, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x12, 0x08, 0x2e,
	0x70, 0x62, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x1a, 0x10, 0x2e, 0x70, 0x62, 0x2e, 0x55, 0x73, 0x65,
	0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x0a, 0x5a, 0x08, 0x2e, 0x2e, 0x2f,
...
var file_user_proto_depIdxs = []int32{
	0, // 0: pb.SayName.SayHello:input_type -> pb.User
	1, // 1: pb.SayName.SayHello:output_type -> pb.UserResponse
...
type SayNameClient interface {
	SayHello(ctx context.Context, in *User, opts ...grpc.CallOption) (*UserResponse, error)
}
...
func (c *sayNameClient) SayHello(ctx context.Context, in *User, opts ...grpc.CallOption) (*UserResponse, error) {
...
type SayNameServer interface {
	SayHello(context.Context, *User) (*UserResponse, error)
}
...
func (*UnimplementedSayNameServer) SayHello(context.Context, *User) (*UserResponse, error) {
...
func _SayName_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SayNameServer).SayHello(ctx, req.(*User))
	}
